...
const css = `
  .tfk-trash{border:1px solid color-mix(in srgb, var(--tfk-primary) 16%, transparent);border-radius:8px;background:#fff;padding:18px;color:#10231d;display:grid;gap:14px}
  .tfk-trash header{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap}.tfk-trash header span{color:var(--tfk-primary);font-size:11px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.tfk-trash h2{margin:3px 0;font-size:20px}.tfk-trash header p{margin:0;color:#587067;font-size:13px}.tfk-trash button{display:inline-flex;align-items:center;justify-content:center;gap:6px;border:1px solid color-mix(in srgb, var(--tfk-primary) 30%, transparent);border-radius:7px;padding:8px 10px;background:var(--tfk-primary-soft);color:#166534;font:inherit;font-size:12px;font-weight:800;cursor:pointer}.tfk-trash button:disabled{opacity:.55;cursor:not-allowed}
  .tfk-trash-error,.tfk-trash-state{border:1px solid color-mix(in srgb, var(--tfk-primary) 14%, transparent);border-radius:7px;padding:11px;background:var(--tfk-card);color:#587067;display:flex;align-items:center;gap:8px;font-size:13px}.tfk-trash-error{border-color:rgba(220,38,38,.3);background:#fef2f2;color:#991b1b}
  .tfk-trash-groups{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.tfk-trash-groups>section{min-width:0;border:1px solid color-mix(in srgb, var(--tfk-primary) 14%, transparent);border-radius:8px;overflow:hidden;align-self:start}.tfk-trash h3{margin:0;padding:10px;display:flex;align-items:center;gap:7px;background:var(--tfk-primary-soft);color:#166534;font-size:13px}.tfk-trash h3 span{margin-left:auto;border-radius:999px;background:#fff;padding:2px 7px;font-size:11px}.tfk-trash article{padding:10px;display:flex;align-items:center;justify-content:space-between;gap:8px;border-top:1px solid color-mix(in srgb, var(--tfk-primary) 10%, transparent)}.tfk-trash article>div{min-width:0;display:grid;gap:3px}.tfk-trash article strong,.tfk-trash article small{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tfk-trash article strong{font-size:12px}.tfk-trash article small,.tfk-trash .read-only,.tfk-trash .bounded{color:#587067;font-size:10px}.tfk-trash .empty,.tfk-trash .bounded{margin:0;padding:12px;color:#587067;font-size:11px}.tfk-trash .spin{animation:tfk-trash-spin .9s linear infinite}@keyframes tfk-trash-spin{to{transform:rotate(360deg)}}
  .tfk-trash-bulk{padding:8px 10px;border-top:1px solid color-mix(in srgb, var(--tfk-primary) 10%, transparent);background:#f0f9ff;display:flex;align-items:center;justify-content:space-between;gap:7px}.tfk-trash-bulk small{color:#526b76;font-size:10px}.tfk-trash-bulk button{padding:6px 8px;background:#0369a1;color:#fff;border-color:#0369a1}.tfk-trash article>input{width:auto;margin:0;accent-color:var(--tfk-primary)}
