...
retention, and lead-messaging increments, it classifies 111 items active, 53 as shared OperatorOS replacements, 49 as open
...
The 49 open items are not waived by the earlier approved-scope state 4
...
contains 49 explicit gaps. Workflow Studio, team job-task views, job
...
scheduling, saved-view, public-intake, remaining retention extensions,
