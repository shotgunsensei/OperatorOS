...
|---|---|---|---|---|---|
| TradeFlowKit | `6d0c13df5e324f6aba9cdf2cf14a550d0cf0ca55`, export v1 | `tradeflowkit_tables` | Authorized JSON; approved users/tenant; Directory customers; jobs/quotes/invoices/payments | Counts, refs, minor-unit financial totals, timestamps, archived state | Frozen export, identity/tenant map, backup/restore |
...
| FaultlineLab | `46877aae35565149ccf4f4988dd94627fc6bb92b` | `faultlinelab_tables` | Four hash-pinned runnable challenges; 52 planned-only cards excluded | Unique IDs/slugs, content hashes, zero authority/billing | Deployed acceptance; future data export separately approved |
...
| StudyForge AI | `a607a9f34442b1d0f6bfffbf0293609529494825` | `studyforge_tables` | Pinned descriptor; subjects/sources/cards/questions/attempts/sessions | Counts/hash, owners, grounding and publication review | Export, owner map, record review |
