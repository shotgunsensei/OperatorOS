...
- PulseDesk's legacy import still lacks immutable upstream source commit
  metadata. TradeFlowKit provenance was recovered in Phase 4 and TechDeck in
  Phase 5; future parity work must recover or explicitly baseline other
  sources.
