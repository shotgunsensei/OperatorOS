...
Workflow Studio, revenue-document, customer-import, core-record, and global-search
increments, it classifies 104 items active, 53 as shared OperatorOS replacements, 56 as open
...
The 56 open items are not waived by the earlier approved-scope state 4
...
contains 56 explicit gaps. Workflow Studio, team job-task views, job
...
groups and canonical record navigation are also active. Destructive bulk
delete/restore is excluded by ADR-0011. Phase 16A
