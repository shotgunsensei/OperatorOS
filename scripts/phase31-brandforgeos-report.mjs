...
const report = [
  ...
  '- Twelve integration projections with shared encrypted credential references, test/live/disabled modes, health, connect/disconnect, queued synchronization, history, retry, and dead-letter authority.',
  '- Six persisted report types with recorded KPI snapshots, white-label branding, SHA-256 integrity, asynchronous HTML/CSV/JSON export jobs, download state, and history.',
  ...
  '## Executable evidence',
  '',
  '- `apps/api/test/brandforgeos-db.test.ts` — onboarding, brand/persona/campaign/copy/calendar/metrics, task/comment/landing/workflow, template gating, deterministic connector synchronization, report hashing, queued export/download, restart persistence, concurrent credits, replay, viewer denial, and tenant isolation.',
  '- `apps/api/test/brandforgeos-phase31-domain.test.ts` — exact copy/tone/workflow/report/integration catalogs, strict schemas, deterministic scoring, integrity hashes, invalid ranges, raw-secret rejection, and export format validation.',
  '- `apps/api/test/brandforgeos-phase31-static.test.ts` — pinned source, additive v40 DDL, required tables, source-compatible routes, premium UI surfaces, and no random metric/report implementation.',
  ...
  '- Focused source/domain/static contract: PASS (5/5).',
