    ...
    >
      ...
      >
        ...
        <section id="launchkit-dashboard" tabIndex={-1} aria-labelledby="launchkit-dashboard-title">
          ...
          {overview && (
            <CoreSuiteSection title="Campaign package details" description="Review the deliverables and export options.">
<article
          ...
          <CoreSuiteSection title="Campaign workspace totals" description="Saved kits, generation usage, and available templates.">
<div
            className="nlk-grid"
