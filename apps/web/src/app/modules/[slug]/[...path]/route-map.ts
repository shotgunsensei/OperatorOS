...
export const CORE_MODULE_DEEP_LINKS: CoreModuleDeepLinkMap = {
  ...
  'callcommand-ai': {
    '/dashboard': { sectionId: 'callcommand-overview-route', label: 'Operations Overview', redirectPath: '/' },
    '/app': { sectionId: 'callcommand-overview-route', label: 'CallCommand AI', redirectPath: '/' },
    '/switchboard': { sectionId: 'callcommand-overview-route', label: 'Operations Overview', redirectPath: '/' },
    '/setup': { sectionId: 'callcommand-commercial-setup', label: 'Set Up CallCommand' },
    '/getting-started': { sectionId: 'callcommand-commercial-setup', label: 'Set Up CallCommand', redirectPath: '/setup' },
    '/onboarding': { sectionId: 'callcommand-commercial-setup', label: 'Set Up CallCommand', redirectPath: '/setup' },
    '/calls': { sectionId: 'callcommand-commercial-calls', label: 'Calls and History' },
    '/operations': { sectionId: 'callcommand-commercial-calls', label: 'Calls and History', redirectPath: '/calls' },
    '/recordings': { sectionId: 'callcommand-commercial-calls', label: 'Calls and History', redirectPath: '/calls' },
    '/transcripts': { sectionId: 'callcommand-commercial-calls', label: 'Calls and History', redirectPath: '/calls' },
    '/analysis': { sectionId: 'callcommand-commercial-calls', label: 'Calls and History', redirectPath: '/calls' },
    '/actions': { sectionId: 'callcommand-work', label: 'Follow-up Work' },
    ...
    '/agents': { sectionId: 'callcommand-commercial-agents', label: 'AI Receptionists' },
    '/profiles': { sectionId: 'callcommand-commercial-agents', label: 'AI Receptionists', redirectPath: '/agents' },
    '/receptionist-profiles': { sectionId: 'callcommand-commercial-agents', label: 'AI Receptionists', redirectPath: '/agents' },
    '/workflows': { sectionId: 'callcommand-commercial-workflows', label: 'Call Workflows' },
    '/automations': { sectionId: 'callcommand-commercial-workflows', label: 'Call Workflows', redirectPath: '/workflows' },
    '/flows': { sectionId: 'callcommand-commercial-workflows', label: 'Call Workflows', redirectPath: '/workflows' },
    '/automation-rules': { sectionId: 'callcommand-commercial-workflows', label: 'Call Workflows', redirectPath: '/workflows' },
    '/numbers': { sectionId: 'callcommand-commercial-numbers', label: 'Phone Numbers' },
    '/channels': { sectionId: 'callcommand-commercial-numbers', label: 'Phone Numbers', redirectPath: '/numbers' },
    '/transfer-targets': { sectionId: 'callcommand-commercial-numbers', label: 'Transfer Destinations', redirectPath: '/numbers' },
    '/usage': { sectionId: 'callcommand-commercial-usage', label: 'Usage and Billing' },
    '/billing': { sectionId: 'callcommand-commercial-usage', label: 'Usage and Billing', redirectPath: '/usage' },
    '/health': { sectionId: 'callcommand-commercial-health', label: 'Health and Readiness' },
    '/readiness': { sectionId: 'callcommand-commercial-health', label: 'Health and Readiness', redirectPath: '/health' },
    '/setup/telephony': { sectionId: 'callcommand-commercial-health', label: 'Health and Readiness', redirectPath: '/health' },
    '/integrations/health': { sectionId: 'callcommand-commercial-health', label: 'Health and Readiness', redirectPath: '/health' },
    '/simulate': { sectionId: 'callcommand-commercial-setup', label: 'Setup Simulation', redirectPath: '/setup' },
    '/simulate/live-call': { sectionId: 'callcommand-commercial-setup', label: 'Setup Simulation', redirectPath: '/setup' },
    '/providers': { sectionId: 'callcommand-providers-route', label: 'Advanced Providers' },
    '/integrations': { sectionId: 'callcommand-providers-route', label: 'Advanced Providers', redirectPath: '/providers' },
