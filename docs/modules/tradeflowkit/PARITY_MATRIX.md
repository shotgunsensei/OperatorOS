...
retention, lead-messaging, saved-view, and accounting-export increments, it classifies 120 items active, 53 as shared OperatorOS replacements, 40 as open
...
The 40 open items are not waived by the earlier approved-scope state 4
...
contains 40 explicit gaps. Workflow Studio, team job-task views, job
