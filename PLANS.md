...
Phase 11A's source/local state-4 gate is complete on its scoped closure branch
pending owner review. The next source phase is Phase 11B, SnapProofOS. That direction
