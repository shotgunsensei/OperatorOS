...
export const DATABASE_RELEASE_STEPS = Object.freeze([
  ...
  { id: 'torqueshed_stripe_credit_catalog', kind: 'ddl' },
  { id: 'torqueshed_checkout_contract', kind: 'ddl' },
  ...
  { id: 'tenant_invitation_consent', kind: 'ddl' },
  { id: 'auth_mfa_tables', kind: 'ddl' },
  { id: 'callcommand_commercial_runtime', kind: 'ddl' },
  { id: 'callcommand_managed_number_provisioning', kind: 'ddl' },
  { id: 'tradeflowkit_constraint_reconciliation', kind: 'repair' },
] as const);
