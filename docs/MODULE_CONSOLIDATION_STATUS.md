...
| --- | --- | --- | --- | --- | --- |
| TradeFlowKit | `tradeflowkit` | `tradeflowkit.operatoros.net` | core | Original baseline `6d0c13df5e324f6aba9cdf2cf14a550d0cf0ca55`; clean restored product evidence `C:\Dev\TradeFlowKit` at `37aa67f1da804fc3ac56f36e50e01362077d7a26` | Complete approved-scope source/local restoration: the executable ledger has zero gaps and zero unclassified items. The persistent shared-runtime product includes workflow/revenue/field-service lifecycle, customer/job/invoice bounded imports, optimistic safe bulk updates, retention restore, global search, saved views, canonical exports, and guarded v1 core-data apply. Exact-host compiled acceptance passes locally. Accepted ADRs exclude duplicate authority, unsafe provider/automation, permanent purge, and destructive bulk behavior. No real export/production cutover occurred; deployed acceptance still blocks state 5 |
...
machine-readable ledger now has zero gaps and zero unclassified source items:
117 active, 65 shared replacements, 45 security retirements, and 50 accepted
product-boundary retirements. Workflow templates/stages, governed job
transitions, team job-task views, activity, source-valid high job priority,
direct invoices, versioned quote/invoice editing, bounded customer/job/invoice
imports, optimistic safe bulk updates, retention restore, global search, saved
views, and idempotent conversions are persisted. Permanent purge, destructive
bulk behavior, duplicate authority, unsafe provider surfaces, and autonomous
automation remain absent by accepted ADRs. The new
...
uses the shared verified receipt/deduplication/retry ledger. TradeFlowKit's
approved source/local behavior is restored and verified. State 5 still
requires deployed workflow/public-document smoke, enabled-provider acceptance,
backup/rollback evidence, and approved real-data reconciliation. A later
import version is needed only if an approved legacy export contains
workflow/general-task/contact records outside bounded v1.
