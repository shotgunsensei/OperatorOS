...
Signed Twilio ingress, consent/replay/idempotency, recording limits and scan
state, redacted structured intelligence, real-provider transfer outcomes, and
tenant-safe automation destinations are release-gated by the platform threat
