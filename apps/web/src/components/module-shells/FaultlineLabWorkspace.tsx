      ...
      <div className="fl-wrap">
        <header className="fl-hero" id="faultlinelab-dashboard" tabIndex={-1}>
          ...
          <div>
            ...
            <p>Hands-on troubleshooting labs with evidence trails, team assignments, scoring, and proof of completion.</p>
          </div>
          <div className="fl-boundaries">
            <span><ShieldCheck size={14} /> Secure team workspace</span>
            <span><Gauge size={14} /> Consistent scoring</span>
            <span><BookOpenCheck size={14} /> Skills practice</span>
          </div>
        </header>
