...
and retention increments, it classifies 109 items active, 53 as shared OperatorOS replacements, 51 as open
...
The 51 open items are not waived by the earlier approved-scope state 4
...
contains 51 explicit gaps. Workflow Studio, team job-task views, job
...
destructive bulk deletion and permanent purge are excluded by ADR-0011. Phase 16A
also adds a read-only
