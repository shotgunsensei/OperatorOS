...
const leadOperationsCss = `
  .tfk-lead-ops { border:1px solid rgba(5,150,105,.2); border-radius:9px; background:#f8fcfa; padding:14px; display:grid; gap:12px; }
  .tfk-lead-ops > header { display:flex; justify-content:space-between; gap:16px; align-items:start; }
  .tfk-lead-ops > header span { color:#059669; font-size:10px; font-weight:900; letter-spacing:.08em; text-transform:uppercase; }
  .tfk-lead-ops h3 { margin:3px 0; font-size:17px; } .tfk-lead-ops p { margin:0; color:#587067; font-size:12px; line-height:1.45; }
  .tfk-lead-ops button { border:1px solid rgba(5,150,105,.25); border-radius:6px; padding:7px 9px; background:#fff; color:#047857; display:inline-flex; align-items:center; justify-content:center; gap:5px; font:inherit; font-size:11px; font-weight:800; cursor:pointer; }
  .tfk-lead-ops button:disabled { opacity:.5; cursor:not-allowed; } .tfk-lead-ops-primary { background:#059669!important; color:#fff!important; }
  .tfk-lead-ops-error,.tfk-lead-ops-notice,.tfk-lead-ops-boundary { border-radius:7px; padding:9px 11px; font-size:12px; }
  .tfk-lead-ops-error { background:#fef2f2; color:#991b1b; border:1px solid #fecaca; } .tfk-lead-ops-notice { background:#ecfdf5; color:#166534; border:1px solid #bbf7d0; }
  ...
  .tfk-lead-ops-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:10px; } .tfk-lead-ops-card { background:#fff; border:1px solid rgba(22,101,52,.14); border-radius:8px; padding:12px; display:grid; gap:10px; align-content:start; } .tfk-lead-ops-wide { grid-column:1/-1; }
  .tfk-lead-ops-title { display:flex; gap:7px; align-items:start; color:#047857; } .tfk-lead-ops-title div { display:grid; gap:2px; } .tfk-lead-ops-title strong { color:#10231d; font-size:13px; } .tfk-lead-ops-title span { color:#587067; font-size:10px; }
  ...
  .tfk-lead-ops-state { min-height:80px; display:flex; align-items:center; justify-content:center; gap:8px; border:1px dashed rgba(22,101,52,.2); border-radius:8px; color:#587067; font-size:12px; }
