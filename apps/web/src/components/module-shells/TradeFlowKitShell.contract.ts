...
export const TRADEFLOWKIT_NAVIGATION: readonly ModuleRouteManifestGroup<TradeFlowKitCapability, TradeFlowKitRole>[] = [
  {
    ...
    items: [
      ...
      { id: 'jobs', canonicalPath: `${prefix}/jobs`, label: 'Jobs', icon: BriefcaseBusiness, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      { id: 'quotes', canonicalPath: `${prefix}/quotes`, label: 'Quotes', icon: FileText, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      { id: 'invoices', canonicalPath: `${prefix}/invoices`, label: 'Invoices', icon: Receipt, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
    ],
  },
  {
    id: 'work',
    ...
    items: [
      { id: 'workflows', canonicalPath: `${prefix}/workflows`, label: 'Workflows', icon: GitBranch, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      { id: 'tasks', canonicalPath: `${prefix}/tasks`, label: 'Team tasks', mobileLabel: 'Tasks', icon: ListChecks, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      { id: 'recurring', canonicalPath: `${prefix}/recurring-jobs`, label: 'Recurring jobs', icon: CalendarClock, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      { id: 'activity', canonicalPath: `${prefix}/activity`, label: 'Activity', icon: Activity, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
    ],
  },
  {
    id: 'insight',
    label: 'Money and records',
    items: [
      { id: 'payments', canonicalPath: `${prefix}/payments`, label: 'Payments', icon: CreditCard, activeMatch: { kind: 'prefix' }, requiredCapability: 'read' },
      ...
      { id: 'directory', canonicalPath: `${prefix}/directory`, label: 'Directory', icon: ContactRound, activeMatch: { kind: 'paths', paths: [`${prefix}/directory`, `${prefix}/contacts`, `${prefix}/sites`] }, requiredCapability: 'read' },
    ],
  },
  {
    id: 'system',
