...
| 16A | Re-baseline TradeFlowKit against the restored full product and close recorded parity gaps | Phase 15 release evidence plus restored-source provenance | In progress. The executable source ledger has zero unclassified items and 23 explicit gaps after eleven real increments: Workflow Studio/team work management, persistent revenue-document mutations, bounded Directory-reconciled customer CSV import, full customer/job/task record editing, bounded tenant-scoped global search with canonical result navigation, tenant-safe archived customer/job/invoice listing plus dependency-ordered restore, replay-safe lead email/consent-gated SMS through the shared outbox, durable saved job views, versioned bounded QuickBooks/Xero accounting exports, non-destructive versioned safe-bulk operations, and versioned internal lead settings/templates with transactional manually actioned follow-ups plus sanitized adapter validation/history. ADR-0030 keeps automatic response, direct provider credentials, and anonymous lead intake disabled; destructive bulk deletion and permanent purge remain excluded under ADR-0011/0029. No real standalone export, production apply, deployment, live-provider acceptance, or state-5 promotion is authorized. |
