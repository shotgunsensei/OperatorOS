...
test('Phase 28 uses the pinned complete TorqueShed source and additive release v38',()=>{
  ...
  assert.match(contract,/releaseVersion:\s*38/);assert.match(contract,/torqueshed_web_api_tables/);
